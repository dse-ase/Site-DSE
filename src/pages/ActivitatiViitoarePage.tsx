  ...
  const evenimente = [
    {
      ...
      descriere: "Studenții masteranzi ASDS pot aplica pentru mobilități internaționale și participări la evenimente de prestigiu precum uRos 2026 sub egida EMOS.",
            ...
            {evenimente.map((eveniment, index) => (
              ...
              >
                <div className="p-8 flex flex-col h-full">
                  {/* Categorie Badge */}
                  <div className="inline-flex items-center w-fit gap-2 bg-gradient-to-r from-[#7209B7] to-[#4361EE] text-white px-3 py-1 rounded-full text-xs font-semibold mb-4">
                    {eveniment.categorie}
                  </div>
