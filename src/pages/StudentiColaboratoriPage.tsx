          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border-2 border-gray-200 dark:border-gray-700">
              <div className="prose prose-lg max-w-none dark:prose-invert">
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-lg mb-0">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border-2 border-[#4361EE] dark:border-[#4CC9F0]">
              <div className="prose prose-lg max-w-none dark:prose-invert">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 italic mb-0 mt-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border-2 border-[#7209B7] dark:border-[#B5179E]">
              <div className="prose prose-lg max-w-none dark:prose-invert">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-0">
                  <span className="font-bold">Ioana Bîrlan</span>, <span className="font-bold">Denisa Trascan</span>, <span className="font-bold">Camelia Dan</span> – studente doctorande Școala Doctorală Cibernetică și Statistică Economică: contribuie la organizarea și desfășurarea seminarului doctoral <a href="https://csie.ase.ro/data-lunch-seria-2-unde-ideile-devin-cunoastere/" target="_blank" rel="noopener noreferrer" className="font-semibold text-[#7209B7] dark:text-[#B5179E] hover:underline transition-all">„Data&Lunch"</a>.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border-2 border-[#4CC9F0] dark:border-[#4361EE]">
              <div className="prose prose-lg max-w-none dark:prose-invert">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-0">
                  <span className="font-bold">Eduard Manta</span>, <span className="font-bold">Ioana Bârlan</span>, <span className="font-bold">Maria Bolboașă</span>, <span className="font-bold">Camelia Dan</span> – studenți doctoranzi Școala Doctorală Cibernetică și Statistică Economică: contribuie la crearea de conținut și administrarea paginilor de social media ale departamentului.
                </p>
              </div>
            </div>
          </motion.div>
